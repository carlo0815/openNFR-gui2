	...
	def VideoChangeDetect(self):
		...
		if video_height and video_width and video_pol and video_rate:
			...
			if config_mode in ('PAL', 'NTSC'):
				...
				if (config.av.autores_deinterlace.value and about.getCPUString() in 'BCM7346B2, BCM7425B2') or config.av.autores_deinterlace.value and about.getCPUString() not in 'BCM7346B2, BCM7425B2' and int(new_res) <= 720:
				...
				if (config.av.autores_deinterlace.value and about.getCPUString() in 'BCM7346B2, BCM7425B2') or config.av.autores_deinterlace.value and about.getCPUString() not in 'BCM7346B2, BCM7425B2' and not config.av.autores_sd.value in '1080i':
