...
class MultiBootManager(Screen, HelpableScreen):
	...
	<screen title="MultiBoot Manager" position="center,center" size="900,455">
		...
		<widget source="key_red" render="Label" position="10,e-50" size="140,40" backgroundColor="red" font="Regular;20" conditional="key_red" foregroundColor="white" halign="center" noWrap="1" valign="center">
			<convert type="ConditionalShowHide" />
		</widget>
		<widget source="key_green" render="Label" position="160,e-50" size="140,40" backgroundColor="green" font="Regular;20" conditional="key_green" foregroundColor="white" halign="center" noWrap="1" valign="center">
			<convert type="ConditionalShowHide" />
		</widget>
		<widget source="key_yellow" render="Label" position="310,e-50" size="140,40" backgroundColor="yellow" font="Regular;20" conditional="key_yellow" foregroundColor="white" halign="center" noWrap="1" valign="center">
			<convert type="ConditionalShowHide" />
		</widget>
		<widget source="key_blue" render="Label" position="460,e-50" size="180,40" backgroundColor="blue" font="Regular;20" conditional="key_blue" foregroundColor="white" halign="center" noWrap="1" valign="center">
			<convert type="ConditionalShowHide" />
		</widget>
		<widget source="key_help" render="Label" position="e-100,e-50" size="90,40" backgroundColor="black" font="Regular;20" conditional="key_help" foregroundColor="white" halign="center" noWrap="1" valign="center">
			<convert type="ConditionalShowHide" />
		</widget>
	</screen>"""
	...
	def __init__(self, session, *args):
		...
		self["actions"] = HelpableActionMap(self, ["OkCancelActions", "ColorActions", "DirectionActions", "KeyboardInputActions", "MenuActions"], {
			"red": (boundFunction(self.close, None), _("Cancel the slot selection and exit")),
			"green": (self.reboot, _("Select the highlighted image and reboot")),
			"ok": (self.reboot, _("Select the highlighted image and reboot")),
			"cancel": (boundFunction(self.close, None), _("Cancel the slot selection and exit")),
