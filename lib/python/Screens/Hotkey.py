...
def getHotkeyFunctions():
	...
	hotkeyFunctions.append((_("Switch channel up"), "Infobar/ChannelPlusPressed", "InfoBar"))
	hotkeyFunctions.append((_("Switch channel down"), "Infobar/ChannelMinusPressed", "InfoBar"))
