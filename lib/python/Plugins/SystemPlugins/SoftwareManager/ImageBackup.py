...
class ImageBackup(Screen):
	...
	def doFullBackup(self, DIRECTORY):
		...
		elif "tar.bz2" in self.ROOTFSTYPE.split() or SystemInfo["HaveMultiBoot"] or SystemInfo["HasRootSubdir"] or self.MACHINEBUILD in ("gbmv200","u51","u52","u53","u54","u5","u5pvr","cc1","sf8008","ustym4kpro","v8plus","multibox","h9combo","hd60","hd61"):
		    self.MKFS = "/bin/tar"
		...
		if ( SystemInfo["HaveMultiBootHD"] or SystemInfo["HaveMultiBootCY"] or SystemInfo["HaveMultiBootOS"]) and self.list[self.selection] == "Recovery":
			BLOCK_SIZE=512
			BLOCK_SECTOR=2
