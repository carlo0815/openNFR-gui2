...
class VFD_INISetup(ConfigListScreen, Screen):
	def __init__(self, session, args = None):
		...
		self.skin = """
			<screen name="VFD_INISetup" position="center,center" size="700,210" title="NFR LED Display Setup">
				<widget name="config" position="0,6" size="700,150" />
				<ePixmap position="0,168" size="140,40" pixmap="skin_default/buttons/green.png" alphatest="on" />
				<ePixmap position="287,168" size="140,40" pixmap="skin_default/buttons/red.png" alphatest="on" />
				<widget name="key_green" position="29,168" size="140,40" font="Regular;20" backgroundColor="un1f771f" zPosition="2" transparent="1" shadowColor="black" shadowOffset="-1,-1" />
				<widget name="key_red" position="317,168" size="140,40" font="Regular;20" backgroundColor="un9f1313" zPosition="2" transparent="1" shadowColor="black" shadowOffset="-1,-1" />
			</screen>"""
...
def main(menuid):
	if menuid != "system":
		return [ ]
	return [(_("NFR Led Control"), startVFD, "VFD_INI", None)]
...
def Plugins(**kwargs):
	return [ PluginDescriptor(where=[PluginDescriptor.WHERE_AUTOSTART, PluginDescriptor.WHERE_SESSIONSTART], fnc=sessionstart),
		PluginDescriptor(name="NFR Led Control", description="Change LED display settings",where = PluginDescriptor.WHERE_MENU, fnc = main) ]
