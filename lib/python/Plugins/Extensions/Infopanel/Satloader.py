	...
	if framewidth == 1280:
		skin = """
			<screen position="240,130" size="800,510" title="Satloader Plugin" >
				<ePixmap position="8,4" size="190,32" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/button_red_sm.png" alphatest="on" />
				<ePixmap position="206,4" size="190,32" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/button_green_sm.png" alphatest="on" />
				<ePixmap position="404,4" size="190,32" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/button_yellow_sm.png" alphatest="on" />
				<ePixmap position="602,4" size="190,32" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/button_blue_sm.png" alphatest="on" />
				...
				<ePixmap position="730,457" size="50,35" zPosition="2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/key_info.png" alphatest="on" />
			</screen>"""
	elif framewidth == 720:
		skin = """
			<screen position="center,center" size="560,460" title="Satloader Plugin" >
				...
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/yellow.png" position="280,0" size="140,40" alphatest="on" />
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/blue.png" position="420,0" size="140,40" alphatest="on" />
				...
				<ePixmap position="505,418" size="35,25" zPosition="2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/key_info.png" alphatest="on" />
			</screen>"""
...
class SatloaderAbout(Screen):
	skin = """
		<screen position="center,center" size="360,280" title="%s">
			<ePixmap position="120,40" size="100,40" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/satloader.png" alphatest="on" />
	...
	if framewidth == 1280:
		...
		skin = """
			<screen position="center,center" size="560,460" title="Satloader Bouquet">
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/red.png" position="0,0" size="140,40" alphatest="on" />
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/buttons/green.png" position="140,0" size="140,40" alphatest="on" />
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/buttons/yellow.png" position="280,0" size="140,40" alphatest="on" />
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/buttons/blue.png" position="420,0" size="140,40" alphatest="on" />
				<widget name="key_red" position="0,0" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#1f771f" transparent="1" />
				<widget name="key_green" position="140,0" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#1f771f" transparent="1" />
				<widget name="list" position="10,50" size="540,350" scrollbarMode="showOnDemand" />
...
def SatListEntry(description, value, index, selected):
	if selected == None:
		...
		if selected == True:
			res.append((eListboxPythonMultiContent.TYPE_PIXMAP_ALPHATEST, 10, 0, 25, 24,  LoadPixmap(cached=True, path="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/lock_on.png")))
		elif selected == False:
			res.append((eListboxPythonMultiContent.TYPE_PIXMAP_ALPHATEST, 10, 0, 25, 24,  LoadPixmap(cached=True, path="/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/pics/lock_off.png")))
		return res
