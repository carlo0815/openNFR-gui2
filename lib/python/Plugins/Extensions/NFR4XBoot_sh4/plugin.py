...
class NFR4XBootImageChoose(Screen):
    ...
    def install(self):
        ...
        if count > 12:
            ...
            menulist.append((_('Install from Internet (OpenATV,OpenNFR,VIX4E2SH4)'), 'internet'))
