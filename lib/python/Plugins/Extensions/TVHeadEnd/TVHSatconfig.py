...
from Plugins.Extensions.TVHeadEnd.TVHNimManager import nimmanager
...
class NimSetup(Screen, ConfigListScreen, ServiceStopScreen):
	...
	def createConfigMode(self):
		if self.nim.canBeCompatible("DVB-S"):
			choices = {"nothing": _("use by TVHeadEnd"),
						"simple": _("Simple"),
						"advanced": _("Advanced")}
	...
	def newConfig(self):
		...
		if self["config"].getCurrent() == self.multiType and self.multiType:
			...
			from Plugins.Extensions.TVHeadEnd.TVHNimManager import InitNimManager
