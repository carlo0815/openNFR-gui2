...
def checkkernel():
    ...
    if getBoxType() in ('bre2ze', 'twinboxlcd', 'optimussos3plus', 'optimussos2plus', 'odin2hybrid', 'axodin', 'sf8', 'odinm7', 'odinm6', 'evoe3hd', 'xp1000', 'xp1000mk', 'uniboxhd1','uniboxhd2', 'uniboxhd3', 'uniboxhde', 'ini-1000de', 'xpeedlxcs2', 'xpeedlxcc', 'xpeedlx2', 'xpeedlx1', 'atemio5x00', 'ini-9000de', 'xpeedlx3', 'ini-8000am', 'atemionemesis', 'vusolo', 'vusolose', 'vuduo', 'vuuno', 'vuultimo', 'vusolo2', 'vuduo2', 'mutant2400', 'quadbox2400', 'formuler1', 'formuler3', 'atemio6200', 'atemio6000'):
       mycheck = 1
