...
def InitUsageConfig():
	...
	config.Fileload = ConfigSubsection()
	config.Fileload.fileuploadport = ConfigInteger(default=8080, limits=(1, 65535))
	config.Fileload.filedeleteport = ConfigInteger(default=8090, limits=(1, 65535))
	...
	if SystemInfo["WakeOnLAN"]:
		def wakeOnLANChanged(configElement):
			if getBoxType() in ('multibox', 'multiboxse', 'anadolmultiboxse', 'axmultiboxse', 'plus', 'hd61', 'hd60', 'h9twin', 'h9combo', 'h10', 'h9', 'et7000', 'et7100', 'et7500', 'gbx1', 'gbx2', 'gbx3', 'gbx3h', 'et10000', 'gbquadplus', 'gbquad', 'gb800ueplus', 'gb800seplus', 'gbultraue', 'gbultraueh', 'gbultrase', 'gbipbox', 'quadbox2400', 'mutant2400', 'et7x00', 'et8500', 'et8500s', 'hzero', 'h8'):
