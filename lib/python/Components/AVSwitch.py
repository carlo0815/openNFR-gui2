...
class AVSwitch:
	...
	if (about.getChipSetString() in ('7366', '7376', '5272s', '7444', '7445', '7445s')):
		...
		modes["HDMI"] = ["720p", "1080p", "1080i", "2160p", "2160p30", "576p", "576i", "480p", "480i"]
		...
		modes["HDMI"] = ["720p", "1080p", "1080i", "2160p", "2160p30"]
		widescreen_modes = {"720p", "1080p", "1080i", "2160p", "2160p30"}
	else:
