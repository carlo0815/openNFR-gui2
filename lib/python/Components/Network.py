...
class Network:
	...
	def isBlacklisted(self, iface):
		return iface in ('lo', 'wifi0', 'wmaster0', 'sit0', 'tun0', 'tap0', 'sys0')
...
# 					print tuple(iface['ip'])
			...
			if iface["preup"] is not False and not "configStrings" in iface:
				fp.write(iface["preup"])
			if iface["predown"] is not False and not "configStrings" in iface:
